...
class GridTextView : View {
    ...
    constructor(context: Context) : super(context) {
        init(null, R.attr.GridTextViewDefault, R.style.Widget_Theme_LearnView_GridTextView)
    }

    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        init(attrs, R.attr.GridTextViewDefault, R.style.Widget_Theme_LearnView_GridTextView)
    }
